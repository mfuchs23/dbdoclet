...
public class TagManager {
	...
	public List<HiddenTree> findHiddenTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<HiddenTree>(), Kind.HIDDEN);
	}
	...
	public List<SerialTree> findSerialTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<SerialTree>(), Kind.SERIAL);
	}

	public List<SerialDataTree> findSerialDataTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<SerialDataTree>(), Kind.SERIAL_DATA);
	}
	...
	public List<SinceTree> findSinceTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<SinceTree>(), Kind.SINCE);
	}
	...
	public List<UsesTree> findUsesTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<UsesTree>(), Kind.USES);
	}
	
	public List<VersionTree> findVersionTags(Element elem) {
		return findBlockTags(elem, () -> new ArrayList<VersionTree>(), Kind.VERSION);
	}
	...
	public boolean isHidden(Element elem) {
		return !findHiddenTags(elem).isEmpty();
	}
