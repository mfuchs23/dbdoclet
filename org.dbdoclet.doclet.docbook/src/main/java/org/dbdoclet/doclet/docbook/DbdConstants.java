...
public class DbdConstants {
	...
	public static final String PARAM_CREATE_FIELD_INFO = "create-field-info";
	public static final String PARAM_CREATE_FULLY_QUALIFIED_NAMES = "create-fully-qualified-names";
	public static final String PARAM_CREATE_INHERITANCE_INFO = "create-inheritance-info";
	public static final String PARAM_CREATE_INHERITED_FROM_INFO = "create-inherited-from-info";
	public static final String PARAM_CREATE_META_INFO = "create-meta-info";
	public static final String PARAM_CREATE_METHOD_INFO = "create-method-info";
