 ...
 * @version 1.0
 */
public class DeprecatedDocletOptions {

	private static Log logger = LogFactory.getLog(DeprecatedDocletOptions.class);
	...
	public DeprecatedDocletOptions(String[][] cmdline) {
